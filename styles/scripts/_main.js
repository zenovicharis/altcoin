...
$(window).on("load", function () {
    ...
    var a = [{
            ...
            Konstantinos: {
                ...
                text: "Konstantinos has over 30 years of experience in Private Banking in Geneva, having worked for Republic National Bank and its successor bank, HSBC, as a Managing Director. In 2005, Konstantinos set up CAPLAND S.A., an independant multi-family office, which is the parent company of Altcoinomy S.A. His experience in asset management and hedge fund business, as well as his wisdom and insights are precious."
            },
            Constantin: {
                name: "Constantin Papadimitriou",
                role: "Chairman",
                text: "Constantin has been the driving force in the development of the family office of a large UK family for over the past 25 years. He is the President and CEO of Diorasis International and General Oriental Investment Ltd. His deal experience and industry contacts provide an invaluable asset to Altcoinomy."
            },
            Ricardo: {
